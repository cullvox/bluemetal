...
class VulkanConfig {
public:
    static inline constexpr uint32_t apiVersion = VK_API_VERSION_1_2; /** @brief Specifies what version of Vulkan we are using. */
    ...
    static inline constexpr uint32_t numFramesInFlight = 3; /** @brief The number of frames the engine will process at a time. */
