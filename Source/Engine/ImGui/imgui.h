...
struct ImDrawCmd
{
    ...
    ImTextureID     TextureId;          // 4-8  // User-provided texture ID. Set by user in ImfontAtlas::SetTexID() for fonts or passed to VulkanImage*() functions. Ignore if never using images or multiple fonts atlas.
