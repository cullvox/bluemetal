...
void Orbit3D::RegisterClass()
{
    ...
    db->RegisterProperty("Orbit3D", MakeClone<TProperty<Orbit3D, float>>("minRadius", PropertyFlags::Editor, &Orbit3D::SetMinRadius, &Orbit3D::GetMinRadius));
    db->RegisterProperty("Orbit3D", MakeClone<TProperty<Orbit3D, float>>("maxRadius", PropertyFlags::Editor, &Orbit3D::SetMaxRadius, &Orbit3D::GetMaxRadius));
    db->RegisterProperty("Orbit3D", MakeClone<TProperty<Orbit3D, float>>("radius", PropertyFlags::Editor, &Orbit3D::SetRadius, &Orbit3D::GetRadius));
    db->RegisterProperty("Orbit3D", MakeClone<TProperty<Orbit3D, float>>("azimuthAngle", PropertyFlags::Editor, &Orbit3D::SetAzimuthAngle, &Orbit3D::GetAzimuthAngle));
    db->RegisterProperty("Orbit3D", MakeClone<TProperty<Orbit3D, float>>("polarAngle", PropertyFlags::Editor, &Orbit3D::SetPolarAngle, &Orbit3D::GetPolarAngle));
}
