...
int main(int argc, const char** argv)
{
    ...
    // ImGui::Text("Graphics Device: %s",
    // Engine::get().getPhysicalDevice()->getDeviceName().c_str()); ImGui::Text("Graphics Vendor:
    // %s", Engine::get().getPhysicalDevice()->getVendorName().c_str()); ImGui::Text("F/S: %d",
    // Engine::get().getFrameCounter().getFramesPerSecond()); ImGui::Text("MS/F: %.2f",
    // Engine::get().getFrameCounter().getMillisecondsPerFrame()); ImGui::Text("Average F/S (Over 10
    // Seconds): %.1f", Engine::get().getFrameCounter().getAverageFramesPerSecond(10));
    // ImGui::Text("Average MS/F (Over 144 Frames): %.2f",
    // Engine::get().getFrameCounter().getAverageMillisecondsPerFrame(144)); ImGui::Text("Present
    // Mode: %s", string_VkPresentModeKHR(currentPresentMode)); ImGui::Text("Surface Format: (%s,
    // %s)", string_VkFormat(currentSurfaceFormat.format),
    // string_VkColorSpaceKHR(currentSurfaceFormat.colorSpace));
    //
    // ImGui::End();
    //
